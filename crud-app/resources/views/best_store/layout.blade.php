...
<!-- //for-mobile-apps -->
<link href="{{ asset('best_store/assets/css/bootstrap.css') }}" rel="stylesheet" type="text/css" media="all" />
<link href="{{ asset('best_store/assets/css/style.css') }}" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script src="{{ asset('best_store/assets/js/jquery.min.js') }}"></script>
<!-- //js -->
<!-- cart -->
<script src="{{ asset('best_store/assets/js/simpleCart.min.js')}}"></script>
<!-- cart -->
<!-- for bootstrap working -->
<script type="text/javascript" src="{{ asset('best_store/assets/js/bootstrap-3.1.1.min.js')}}"></script>
<!-- //for bootstrap working -->
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,300,300italic,400italic,600,600italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,700italic,900,900italic' rel='stylesheet' type='text/css'>
<!-- timer -->
<link rel="stylesheet" href="{{ asset('best_store/assets/css/jquery.countdown.css')}}" />
<!-- //timer -->
<!-- animation-effect -->
<link href="{{ asset('best_store/assets/css/animate.min.css')}}" rel="stylesheet"> 
<script src="{{ asset('best_store/assets/js/wow.min.js')}}"></script>
<script>
 new WOW().init();
</script>
<!-- //animation-effect -->
			...
			<div class="logo-nav">
				...
				<div class="logo-nav-right">
					<div class="search-box">
						...
						<!-- search-scripts -->
						<script src="{{ asset('best_store/assets/js/classie.js')}}"></script>
						<script src="{{ asset('best_store/assets/js/uisearch.js')}}"></script>
							<script>
					...
					<div class="cart box_1">
						<a href="checkout.html">
							<h3> <div class="total">
								...
								<img src="{{ asset('best_store/assets/images/bag.png')}}" alt="" />
							</h3>
						</a>
		...
		<div class="container">
			<div class="banner-info animated wow zoomIn" data-wow-delay=".5s">
				...
				<div class="wmuSlider example1">
					...
					<script src="{{ asset('best_store/assets/js/jquery.wmuSlider.js')}}"></script> 
					<script>
						$('.example1').wmuSlider();         
					</script> 
			</div>
			...
			<div class="banner-bottom-grids">
				<div class="banner-bottom-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<div class="grid">
						<figure class="effect-julia">
							<img src="{{ asset('best_store/assets/images/4.jpg')}}" alt=" " class="img-responsive" />
							<figcaption>
				...
				<div class="banner-bottom-grid-left1 animated wow slideInUp" data-wow-delay=".5s">
					<div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
						<div class="banner-bottom-grid-left-grid1">
							<img src="{{ asset('best_store/assets/images/1.jpg')}}" alt=" " class="img-responsive" />
						</div>
					...
					<div class="banner-bottom-grid-left-grid left1-grid grid-left-grid1">
						<div class="banner-bottom-grid-left-grid1">
							<img src="{{ asset('best_store/assets/images/2.jpg')}}" alt=" " class="img-responsive" />
						</div>
				...
				<div class="banner-bottom-grid-right animated wow slideInRight" data-wow-delay=".5s">
					<div class="banner-bottom-grid-left-grid grid-left-grid1">
						<div class="banner-bottom-grid-left-grid1">
							<img src="{{ asset('best_store/assets/images/3.jpg')}}" alt=" " class="img-responsive" />
						</div>
			...
			<div class="footer-grids">
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".7s">
					...
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{ asset('best_store/assets/images/13.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{ asset('best_store/assets/images/14.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{ asset('best_store/assets/images/15.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{ asset('best_store/assets/images/16.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
					<div class="footer-grid-left">
						<a href="single.html"><img src="{{ asset('best_store/assets/images/13.jpg')}}" alt=" " class="img-responsive" /></a>
					</div>
				...
				<div class="col-md-3 footer-grid animated wow slideInLeft" data-wow-delay=".8s">
					...
					<div class="footer-grid-sub-grids">
						<div class="footer-grid-sub-grid-left">
							<a href="single.html"><img src="{{ asset('best_store/assets/images/9.jpg')}}" alt=" " class="img-responsive" /></a>
						</div>
					...
					<div class="footer-grid-sub-grids">
						<div class="footer-grid-sub-grid-left">
							<a href="single.html"><img src="{{ asset('best_store/assets/images/10.jpg')}}" alt=" " class="img-responsive" /></a>
						</div>
						<div class="footer-grid-sub-grid-right">
